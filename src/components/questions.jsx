...
export default function questions({ page }) {
    ...
    {
        image: "sgr-s23xDAYQBCo-unsplash.webp",
        ...
        feedback: "The answer is all of the above. These issues and more are mainly a result of human impact, and have harmed and devasted ecosystems all around the world. It is projected that in a few decades, the damages will be irreversible." +
            "-Here are some methods to help lessen the impact: 1. Reduce Plastic Consumption: 2. Use reusable bags, bottles, and containers. 3. Reduce Carbon Footprint: Use renewable energy resources and by reducing car travel by biking or using public transportation 4. Conserve Water: Reduce water consumption by taking shorter showers, or using less water in general to reduce energy and greenhouse gas emissions."
    },
    {
        ...
        options: ["30%", "50%", "60%", "80%"],
        correct_answer: "80%",
        feedback: "Over 80% of marine pollution comes from land based sources. These include: 1. Industrial waste from corporations leaking toxic chemicals, and other materials into waterways, destroying ecosystems. This is creating an alarming amount of deadzones where marine life can't live, due to the oxygen content.2. Plastic: Plastic items such as straws, bags, bottles, have had an innumerable impact on marine life"
    },
    {
    ...
    return (
        ...
        <div className="flex justify-center flex-col items-center">
            ...
            {questions.map((Q, key) => (
                <div key={key} className={`border rounded-lg mx-2 bg-blue-200 mb-10 ${styles.container}`}>
                    ...
                    <div className="flex justify-center">
                        <div className={`w-96 grid grid-cols-2 gap-x-16 gap-y-5 ${styles.buttons}`}>
