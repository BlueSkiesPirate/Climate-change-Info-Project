        ...
        <>
            <div className="pt-16">
                ...
                <div id="picturesAndInfo">
                    <div className="clearfix" id="clearfix1">
                        <div id="image-container-for-padding">
                            <div className="image-container">
                                <img src="Hackathon_Img/data-viz-coral-reefs-en-slide_01.png" className="rounded float-start" alt="" />
                                <img src="Hackathon_Img/data-viz-coral-reefs-en-slide_02.png" className="rounded mx-auto d-block" alt="" />
                                <img src="Hackathon_Img/data-viz-coral-reefs-en-slide_03.png" className="rounded float-end" alt="" />
                            </div>
                        </div>
                        <p>
                            ...
                            <br /><br />Reference: The UN
                        </p>
                    </div>

                    <hr className="rounded" />

                    <div className="clearfix" id="clearfix2">
                        <img src="Hackathon_Img/MarineLifeAlterationsOverTime.png" className="col-md-6 float-md-start mb-3 ms-md-3" alt="" />
                        <p>
                            ...
                            <br /><br />Reference: science.nasa.gov
                        </p>
                    </div>

                    <hr className="rounded" />

                    <div className="clearfix" id="clearfix3">
                        <img src="Hackathon_Img/WarmingOfOcean.png" className="col-md-6 float-md-end mb-3 ms-md-3" alt="" />
                        <p>
